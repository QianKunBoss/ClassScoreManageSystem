...
try {
    ...
    $stmt->execute(['security_question']);
    $result = $stmt->fetch();
    if ($result) {
        $security_question = $result['setting_value'];
    }
    
    $stmt->execute(['security_answer']);
    $result = $stmt->fetch();
    if ($result) {
        $security_answer = $result['setting_value'];
    }
