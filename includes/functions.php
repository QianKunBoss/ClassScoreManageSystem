    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                echo '
                    <li class="nav-item">
                        <a class="nav-link" href="../pages/user_management.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../pages/data_dashboard.php">
                ...
                if (!in_array($currentPage, ['admin.php', 'user_detail.php', 'add_user.php', 'import_users.php', 'dengluye.php', 'adjust_score.php', "settings.php", "template_management.php", "data_dashboard.php", "user_management.php"])) {
                 echo '
                    <li class="nav-item">
