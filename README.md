...
- 🔌 [外部开放 API 文档（v1）](./docs/APIv1.md) — 第三方对接的 `/api/v1/**` 接口、鉴权、幂等、限流与错误码
- 🛠 [内部 API 接口文档](./docs/api.md) — 管理员 Session 认证的 `/api/**` 接口说明
...
- 完整接口文档见 [APIv1.md](./docs/APIv1.md)
...
- [API 接口文档（内部 / 管理员 Session）](./docs/api.md) - 内部 `/api/**` 接口说明
- [外部开放 API 文档（v1）](./docs/APIv1.md) - 第三方对接的 `/api/v1/**` 接口、鉴权、幂等、限流与错误码
